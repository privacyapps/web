    ...
    subCategories: [
      {
        ...
        links: [
          ...
          { name: 'Techlore', sources: [{type: 'youtube', url: 'https://www.youtube.com/@techlore'}, {type: 'website', url: 'https://techlore.tech'}], imgId: imgIdCounter++, description: `Techlore offers high-quality videos and content for all experience levels, covering a wide variety of topics.`, tags: ['YouTube', 'Tutorials'], customIcon: `${ICON_BASE_URL}/icons/techlore.jpg` },
          { name: 'Sun Knudsen', sources: [{type: 'youtube', url: 'https://www.youtube.com/@SunKnudsen'}], imgId: imgIdCounter++, description: `Sun Knudsen offers tutorials, typically geared to a more advanced audience.`, tags: ['YouTube', 'Tutorials'], customIcon: `${ICON_BASE_URL}/icons/sun-knudsen.jpg` },
