    ...
    subCategories: [
      ...
      },
      {
        ...
        links: [
          ...
          { name: 'App Manager', sources: [{type: 'website', url: 'https://github.com/MuntashirAkon/AppManager'}, {type: 'github', url: 'https://github.com/MuntashirAkon/AppManager'}, {type: 'fdroid', url: 'https://f-droid.org/en/packages/io.github.muntashirakon.AppManager'}], imgId: imgIdCounter++, description: 'A powerful and advanced package manager for Android, allowing users to inspect, control, and manage apps on their device. It offers features like viewing app components, blocking trackers, managing permissions, and more.', tags: ['Open Source', 'Android', 'Free', 'App Manager', 'Utilities', 'Advanced', 'Security'], customIcon: `${ICON_BASE_URL}/icons/app-manager.jpg` },
          { name: 'Inure', sources: [{type: 'website', url: 'https://github.com/Hamza417/Inure'}, {type: 'github', url: 'https://github.com/Hamza417/Inure'}, {type: 'playstore', url: 'https://play.google.com/store/apps/details?id=app.simple.inure.play'}, {type: 'fdroid', url: 'https://f-droid.org/en/packages/app.simple.inure/'}], imgId: imgIdCounter++, description: 'A powerful open-source app manager for Android that allows you to take control of your installed applications. You can disable/enable any app components, block trackers, manage permissions, and perform batch operations.', tags: ['Open Source', 'Android', 'Free', 'App Manager', 'Utilities', 'Security'], customIcon: `${ICON_BASE_URL}/icons/inure.jpg` },
          ...
          { name: 'Image Toolbox', sources: [{type: 'github', url: 'https://github.com/T8RIN/ImageToolbox'}, {type: 'playstore', url: 'https://play.google.com/store/apps/details?id=ru.tech.imageresizershrinker'}, {type: 'fdroid', url: 'https://f-droid.org/en/packages/ru.tech.imageresizershrinker/'}], imgId: imgIdCounter++, description: 'A powerful app for processing images, offering features like viewing, editing, and clearing metadata (Exif), resizing, and compression. It supports batch processing to handle multiple images at once.', tags: ['Open Source', 'Android', 'Free', 'Utilities', 'Security', 'Metadata'], customIcon: `${ICON_BASE_URL}/icons/image-toolbox.jpg` },
...
},
{
  ...
  subCategories: [
    ...
    },
    {
      ...
      sidebarIcon: 'Mail',
      links: [
        { name: 'DDG Email Protection', sources: [{type: 'website', url: 'https://duckduckgo.com/email/'}, {type: 'playstore', url: 'https://play.google.com/store/apps/details?id=com.duckduckgo.mobile.android'}, {type: 'github', url: 'https://github.com/duckduckgo/duckduckgo-privacy-extension'}, {type: 'chrome', url: 'https://chromewebstore.google.com/detail/duckduckgo-privacy-essent/bkdgflcldnnnapblkhphbgpggdiikppg'}, {type: 'firefox', url: 'https://addons.mozilla.org/en-US/firefox/addon/duckduckgo-for-firefox/'}], imgId: imgIdCounter++, description: 'DuckDuckGo Email Protection is a free email forwarding service that removes trackers from your emails and lets you create unique, private email addresses on the fly.', tags: ['Open Source', 'Free', 'Aliasing', 'Web Extension'], customIcon: `${ICON_BASE_URL}/icons/duckduckgo-email-protection.jpg` },
